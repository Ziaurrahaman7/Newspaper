...
<head>
	...
	<meta name="twitter:image" content="../../../../wdp.joycalls.com/index2d0a.html">
	<!-- Facebook -->
	...
	<meta property="og:image" content="../../../../wdp.joycalls.com/index2d0a.html">
	...
	<link rel="stylesheet" type="text/css" href="{{asset('assets')}}/css/iconfont.css">
	<!-- css links
    	======================================== -->
	<!-- Bootstrap link -->
    ...
    <style>
        .axil-img-container:hover > a > .vedio {
            transform: scale(1.1);
        }
