...
@section('content')
<x-table link="/admin/sitesetting/create" name="Update sitesetting" title="Site setting">
...
<tbody>
    @foreach ($sitesettings as  $sitesetting)
        <tr>
            <td> <img width="50px" src="{{asset('storage/uploads/'.$sitesetting->logo)}}" alt=""></td>
            <td><img  width="50px"  src="{{asset('storage/uploads/'.$sitesetting->favicon)}}" alt=""></td>
